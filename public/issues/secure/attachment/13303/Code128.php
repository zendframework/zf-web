 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Validate_Barcode_Code128 extends Zend_Validate_Barcode_AdapterAbstract
{
    /**
     ...
     * @var string
     */
    protected $_characters = '0123456789abcdefghiklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ .!"#&$+%()*+,-/:;<=>?@[\\]^_`{|}~\'';
