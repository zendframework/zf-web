...
class Zend_Loader_Autoloader_ResourceTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAutoloaderResourceTestOverloadResourceType()
    {
        $this->loader->addResourceTypes(array(
            'mapper' => array('path' => 'models/mappers', 'namespace' => 'Model_Mapper'),
            'model'  => array('path' => 'models', 'namespace' => 'Model')
        ));
        $path = $this->loader->getClassPath('FooBar_Model_Mapper_ZendLoaderAutoloaderResourceTestOverloadResourceType');
        $assertPath = $this->loader->getBasePath() . '/models/Mapper/ZendLoaderAutoloaderResourceTestOverloadResourceType.php';
        $this->assertEquals($assertPath, $path);
    }
}
