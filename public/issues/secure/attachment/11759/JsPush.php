...
class Zend_ProgressBar_Adapter_JsPush extends Zend_ProgressBar_Adapter
{
    ...
    /**
     * True if the call is made by a ajax request
     * 
     * @var boolean
     */
      
    protected $_ajaxAccess = true;
    ...
    /**
     * Set the access method, true for ajax, false for iframe
     * 
     * $param boolean $ajaxAccess
     * @return Zend_ProgressBar_Adapter_JsPush
     */
    public function setAjaxAccess($ajaxAccess)
    {
    	$this->_ajaxAccess = $ajaxAccess;
    ...
    public function notify($current, $max, $percent, $timeTaken, $timeRemaining, $text)
    {
        ...
        if(!$this->_ajaxAccess){
	        ...
	        $data = $this->_updateMethodName . '(' . Zend_Json::encode($arguments) . ');';
        }
