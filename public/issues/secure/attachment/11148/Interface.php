 ...
 * @version    $Id: $
 */
interface Zend_Form_SubForm_Interface
{
    /**
    ...
    /**
     * Set single element's default value
     * 
     * @param  string $name 
     * @param  mixed $value 
     * @return Zend_Form_SubForm_Interface
    ...
    /**
     * Add prefix path for display groups 
     * 
     * @param  string $prefix 
     * @param  string $path 
     * @return Zend_Form_SubForm_Interface
    ...
    /**
     * Get array to which elements belong
     * 
     * @return string
     */
    ...
    /**
     * Are the elements members of an array?
     * 
     * @return bool
     */
