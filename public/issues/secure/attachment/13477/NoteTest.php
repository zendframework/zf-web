...
class Zend_Form_Element_NoteTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testNoteElementValidationIsAlwaysTrue()
    {
        ...
        $validators = array(
            ...
            array(
                'options' => array('Between', false, array('min' => 0, 'max' => 10)),
                'value'   => '11',
            ),
            array(
                'options' => array('Date'),
            ...
            array(
                'options' => array('GreaterThan', false, array('min' => 10)),
                'value'   => '9',
            ),
            array(
                'options' => array('Hex'),
            ...
            array(
                'options' => array('InArray', false, array('key' => 'value', 'otherkey' => 'othervalue')),
                'value'   => 'foo',
            ),
            array(
                'options' => array('Int'),
            ...
            array(
                'options' => array('LessThan', false, array('max' => 10)),
                'value'   => '11',
            ),
            array(
            ...
            array(
                'options' => array('Regex', false, array('pattern' => '/^Test/')),
                'value'   => 'Pest',
            ),
            array(
                'options' => array('StringLength', false, array(6, 20)),
                'value'   => 'foo',
            ),
        );
