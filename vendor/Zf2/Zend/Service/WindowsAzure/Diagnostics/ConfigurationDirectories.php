 ...
 */
class ConfigurationDirectories extends ConfigurationObjectBaseAbstract
{
    /**
     * Constructor
     * 
    ...
    {
    	$this->_data['subscriptions'][$path] = new Zend\Service\WindowsAzure\Diagnostics\DirectoryConfigurationSubscription($path, $container, $directoryQuotaInMB);
    }
