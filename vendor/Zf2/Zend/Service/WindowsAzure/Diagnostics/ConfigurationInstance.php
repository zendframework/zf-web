 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 *
 * @property Zend\Service\WindowsAzure\Diagnostics\ConfigurationDataSources	DataSources	Data sources
 */
class ConfigurationInstance extends ConfigurationObjectBaseAbstract
{
	/**
	 * Constructor
	 */
	...
	{
        $this->_data = array(
            'datasources'	=> new Zend\Service\WindowsAzure\Diagnostics\ConfigurationDataSources()
        );
	}
