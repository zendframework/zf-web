...
/**
 * @category   Zend
 * @package    Zend\Service\WindowsAzure\Credentials
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */ 
abstract class CredentialsAbstract
{
	...
	/**
	 * Creates a new Zend\Service\WindowsAzure\Credentials\CredentialsAbstract instance
	 *
	...
	public function __construct(
		$accountName = Zend\Service\WindowsAzure\Credentials\CredentialsAbstract::DEVSTORE_ACCOUNT,
		$accountKey  = Zend\Service\WindowsAzure\Credentials\CredentialsAbstract::DEVSTORE_KEY,
	 ...
	 *
	 * @param  string $value
	 * @return Zend\Service\WindowsAzure\Credentials\CredentialsAbstract
	 */
	public function setAccountName($value = Zend\Service\WindowsAzure\Credentials\CredentialsAbstract::DEVSTORE_ACCOUNT)
	{
	 ...
	 * @return Zend\Service\WindowsAzure\Credentials\CredentialsAbstract
	 */
	public function setAccountkey($value = Zend\Service\WindowsAzure\Credentials\CredentialsAbstract::DEVSTORE_KEY)
	{
	...
	abstract public function signRequestUrl(
		$requestUrl = '',
		$resourceType = Zend\Service\WindowsAzure\Storage::RESOURCE_UNKNOWN,
		$requiredPermission = Zend\Service\WindowsAzure\Credentials\CredentialsAbstract::PERMISSION_READ
	);
