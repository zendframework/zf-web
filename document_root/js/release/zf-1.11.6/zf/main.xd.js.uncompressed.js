...
return {depends: [["provide", "zf.Block"],
["provide", "zf.ManualComment"],
["provide", "zf.ManualNavigation"],
["provide", "zf.download"],
["provide", "dojox.highlight._base"],
["provide", "dojox.highlight"],
["provide", "zf.php"],
...
["provide", "zf.main"],
["i18n._preloadLocalizations", "zf.nls.main", ["ROOT","ar","ca","cs","da","de","de-de","el","en","en-gb","en-us","es","es-es","fi","fi-fi","fr","fr-fr","he","he-il","hu","it","it-it","ja","ja-jp","ko","ko-kr","nb","nl","nl-nl","pl","pt","pt-br","pt-pt","ru","sk","sl","sv","th","tr","xx","zh","zh-cn","zh-tw"]]],
...
if(!dojo._hasResource["zf.Block"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["zf.Block"] = true;
...
if(!dojo._hasResource["zf.ManualComment"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["zf.ManualComment"] = true;
...
if(!dojo._hasResource["zf.ManualNavigation"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["zf.ManualNavigation"] = true;
...
d.mixin(zf, {
    ManualNavigation: { generate: function() {
        ...
        var toc = function(section, container, margin) {
            ...
            dojo.query("#" + dojo.attr(section, "id").replace(/(:|\.)/g,'\\$1') + ' > .section[id^="zend."]').forEach(getSectionTitles);
            dojo.query("#" + dojo.attr(section, "id").replace(/(:|\.)/g,'\\$1') + ' > .section[id^="learning."]').forEach(getSectionTitles);
...
if(!dojo._hasResource["zf.download"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["zf.download"] = true;
...
if(!dojo._hasResource["zf.php"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["zf.php"] = true;
dojo.provide("zf.php"); 
...
if(!dojo._hasResource["zf.main"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
