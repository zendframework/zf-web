...
- [4870: Use MvcTranslator to inject view helpers](https://github.com/zendframework/zf2/issues/4870)',
  '2.2.3' => 'Zend Framework 2.2.3 (2013-08-21)
====================
...
- [5028: Fix forms regression introduced in 2.2.3](https://github.com/zendframework/zf2/issues/5028)',
  '2.2.5' => 'Zend Framework 2.2.5 (2013-10-31)
...
- [#5343](https://github.com/zendframework/zf2/pull/5343) removed the
  ...
  expected.',
  '2.1.6' => 'Zend Framework 2.1.6 (2014-03-06)
====================
...
- **ZF2014-01:** Potential XXE/XEE attacks using PHP functions:
  ...
  '2.2.6' => 'Zend Framework 2.2.6 (2014-03-06)
====================
...
- **ZF2014-01:** Potential XXE/XEE attacks using PHP functions:
  ...
  were potentially vulnerable to these attacks. If you use either of these
  components, we recommend upgrading immediately.',
  '2.3.0' => 'Zend Framework 2.3.0 (2014-03-12)
...
- [5951: Fix console mixed case optional value params](https://github.com/zendframework/zf2/pull/5951)',
  '2.2.7' => 'Zend Framework 2.2.7 (2014-04-15)
====================
...
- **ZF2014-03:** Potential XSS vector in multiple view helpers due to
  ...
  '2.3.1' => 'Zend Framework 2.3.1 (2014-04-15)
====================
...
- **ZF2014-03:** Potential XSS vector in multiple view helpers due to
  ...
  (such as `gravatar()`, `htmlFlash()`, `htmlPage()`, or `htmlQuicktime()`), we
  recommend upgrading immediately.',
  '2.3.2' => 'Zend Framework 2.3.2 (2014-08-12)
...
- **ZF2014-06:** A potential SQL injection vector existed when using a SQL
  ...
  '2.3.3' => 'Zend Framework 2.3.3 (2014-09-16)
...
',
  '2.3.4' => 'Zend Framework 2.3.4 (2015-01-14)
...
- **ZF2015-01:** Session validators were not run if set before session start.
  ...
  validators, we recommend upgrading immediately.
',
  '2.2.10' => 'Zend Framework 2.2.10 (2015-02-17)
...
',
  '2.3.5' => 'Zend Framework 2.3.5 (2015-02-18)
...
- [7255: Revert BC break against AbstractRestfulController](https://github.com/zendframework/zf2/pull/7255)',
  '2.4.0' => 'Zend Framework 2.4.0 (2015-03-31)
...
- [7375: Correcting](https://github.com/zendframework/zf2/pull/7375)',
  '2.3.8' => 'Zend Framework 2.3.8 (2015-05-07)
...
- **ZF2015-04**: `Zend\\Mail` and `Zend\\Http` were both susceptible to CRLF Injection Attack vectors (for HTTP, this is often referred to as HTTP Response Splitting). Both components were updated to perform header value validations to ensure no values contain characters not detailed in their corresponding specifications, and will raise exceptions on detection. Each also provides new facilities for both validating and filtering header values prior to injecting them into header classes.  If you use either `Zend\\Mail` or `Zend\\Http` (which includes users of `Zend\\Mvc`), we recommend upgrading immediately.',
  '2.4.1' => 'Zend Framework 2.4.1 (2015-05-07)
...
- **ZF2015-07**: The filesystem storage adapter of `Zend\\Cache` was creating directories with a liberal umask that could lead to local arbitrary code execution and/or local privilege escalation. This release contains a patch that ensures the directories are created using permissions of 0775 and files using 0664 (essentially umask 0002).',
  '2.4.9' => 'Zend Framework 2.4.9 (2015-11-23)
